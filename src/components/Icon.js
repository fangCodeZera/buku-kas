/**
 * components/Icon.js
 * Lightweight SVG icon system using path data.
 * Add new icons by extending IPATHS — no external icon library needed.
 */
...
export const IPATHS = {
  ...
  inventory:
    "M20 7l-8-4-8 4m16 0v10l-8 4-8-4V7 M12 11v10",
  settings:
